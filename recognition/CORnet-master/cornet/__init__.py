...
from cornet.cornet_z_se import CORnet_Z_SE
from cornet.cornet_z_se import HASH as HASH_Z_SE
...
def cornet_z(pretrained=False, map_location=None):
    return get_model('z_se', pretrained=pretrained, map_location=map_location)